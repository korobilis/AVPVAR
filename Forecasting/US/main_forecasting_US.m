%% Replication code
% This script conducts the out-of-sample forecasts for US data, comparing
% AVPVAR with 8 different models. 
...
standard   = 1;      % 0: no standardization. 1: standardized

%% ======|Please choose Drivers Z:
...
standardZ  = 1;      % 0: no standardization. 1: standardized


%% ======| LOOP OVER DIFFERENT LAG VALUES p
p_values = [1 2 3 4];  % Choose different lag-length
...
for p_idx = 1:length(p_values)
    ...
    nsave    = 5000;         % Store nsave MCMC iterations 
    ...
    filename = sprintf('oos_US_p%d.mat', p);
    save(filename);
