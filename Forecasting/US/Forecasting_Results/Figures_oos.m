%% OOS Forecast for U.S. monthly data: All Sample

clear; close all; clc;
for k = 1:4
suffix = sprintf('p%d',k);
loadFile = sprintf("oos_US_%s.mat", suffix);
saveFile = sprintf("Appendix_Figures\\Appendix_Forecasting_US_%s.pdf", suffix);
