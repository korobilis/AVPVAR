...
loadFile = sprintf("oos_FREDQD_%s.mat", suffix);
saveFile = sprintf("Appendix_Figures\\OOS_FRED_%s.pdf", suffix);
...
% Tiled layout with space for legend at bottom
...
markers = {'o','s','d','^','v','p','h','*'};
titles_text = {
'Panel (a): GDPC1 - MAE','Panel (b): PCECTPI - MAE',...
'Panel (c): GDPC1 - QScore90','Panel (d): PCECTPI - QScore90',...
'Panel (e): GDPC1 - QScore10','Panel (f): PCECTPI - QScore10'
};
